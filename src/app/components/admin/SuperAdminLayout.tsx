...
import { LayoutDashboard, School, Users, BarChart3, Settings, LogOut, Terminal, Activity, Bell, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="flex h-screen" style={{ background: "#0B0F1A" }}>
      ...
      <div className="w-60 flex flex-col relative"
        ...
        <div className="p-5" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg"
            ...
            <span style={{ color: "#FCA5A5", fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.5px" }}>RESTRICTED AREA</span>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Topbar */}
        <div className="h-14 flex items-center justify-between px-7"
