...
interface DonorNotificationSettingsProps {
  isOpen: boolean;
  onClose: () => void;
}
...
export function DonorNotificationSettings({ isOpen, onClose }: DonorNotificationSettingsProps) {
      ...
      <div className="w-full max-w-[430px] bg-white rounded-t-3xl p-6 pb-8 animate-slide-up max-h-[85vh] overflow-y-auto">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            {[
              { key: "donationSuccess" as const, label: "Donasi Berhasil", desc: "Konfirmasi setiap donasi yang Anda berikan" },
              { key: "campaignUpdate" as const, label: "Update Kampanye", desc: "Perkembangan kampanye yang Anda dukung" },
              { key: "campaignComplete" as const, label: "Kampanye Selesai", desc: "Notifikasi saat kampanye mencapai target" },
              { key: "newCampaign" as const, label: "Kampanye Baru", desc: "Informasi kampanye baru yang tersedia" },
